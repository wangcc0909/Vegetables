 ...
 * @author peaut
 * @package com.google.zxing.activity
 * @fileName CaptureActivity
 * @date on  2019/3/21  16:30
 */
public class CaptureActivity extends AppCompatActivity implements Callback {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setStatusBar();
        View view = findViewById(R.id.myStatusBar);
        ViewGroup.LayoutParams params = view.getLayoutParams();
        params.height = StatusBarHelper.INSTANCE.getStatusBarHeight(this);
...
//		cancelScanButton = (Button) this.findViewById(R.id.btn_cancel_scan);
    ...
    public void setStatusBar() {
        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.LOLLIPOP) {//5.0以上
            ...
            localLayoutParam.flags = (WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS | localLayoutParam.flags);
        }
    }
