...
class SpacesItemDecoration private constructor(private val itemSplitMarginEven: Int, private val itemSplitMarginLarge: Int, private val itemSplitMarginSmall: Int, private val verticalSpacing: Int, color: Int) : RecyclerView.ItemDecoration() {
    ...
    protected fun getSpanLookup(view: View, parent: RecyclerView): SpanLookup {
    ...
    private fun applyItemVerticalOffsets(outRect: Rect, itemPosition: Int, childCount: Int, spanCount: Int, spanLookup: SpanLookup, adapter: LRecyclerViewAdapter) {
    ...
    companion object {
        ...
        private fun getItemTopSpacing(spanLookup: SpanLookup, verticalSpacing: Int, itemPosition: Int, spanCount: Int, childCount: Int, adapter: LRecyclerViewAdapter): Int {
        ...
        private fun getItemBottomSpacing(spanLookup:SpanLookup, verticalSpacing: Int, itemPosition: Int, childCount: Int, adapter: LRecyclerViewAdapter): Int {
