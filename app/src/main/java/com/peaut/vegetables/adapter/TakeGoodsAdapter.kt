 ...
 * @author peaut
 * @package  com.peaut.vegetables.adapter
 * @fileName TakeGoodsAdapter
 * @date on  2019/3/12  15:11
 */
class TakeGoodsAdapter(context: Context): BaseMultiAdapter<MultiItemEntity>(context){
    private var mListener: OnTextViewClickListener? = null
    init {
        addItemType(Constant.ITEM_EMPTY_TYPE, R.layout.item_order_empty_layout)
        addItemType(Constant.ITEM_ORDER_TYPE,R.layout.item_take_goods_layout)
